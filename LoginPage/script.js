  ...
  fetch('https://jsonplaceholder.typicode.com/users')
    ...
    .then((json) => {
      ...
      if (userInput.value === users[0][i].username &&
        ...
        userCheckResult.innerHTML = '<span> Valid User </span> <img src="/Roland-Musical page/img/checked.png" width="30px">';
        passwordCheckResult.innerHTML = '<span> Correct Password </span> <img src="/Roland-Musical page/img/checked.png" width="30px">';
        break;
      } else {
        userCheckResult.innerHTML = '<span> Invalid User </span> <img src="/Roland-Musical page/img/error.png" width="30px">';
        passwordCheckResult.innerHTML = '<span> Wrong Password </span> <img src="/Roland-Musical page/img/error.png" width="30px">';
      }
    }
...
const verifyEmail = () => {
  if (emailInput.value.match(/(?:[a-z0-9+!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|"(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21\x23-\x5b\x5d-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])*")@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\[(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?|[a-z0-9-]*[a-z0-9]:(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21-\x5a\x53-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])+)\])/gi)) {
    emailCheckResult.innerHTML = 'Excellent! "' + emailInput.value + '" is a valid email address. <img src="/Roland-Musical page/img/checked.png" width="30px">';
  } else {
    emailCheckResult.innerHTML = 'Sorry, but "' + emailInput.value + '" is not a valid email address. <img src="/Roland-Musical page/img/error.png" width="30px">';
  }
}
...
function checkRepeat () {
  ...
  if(passwordRepeatInput.value === passwordInput1.value) {
    passwordRepeatInputResult.innerHTML = 'Perfect! Passwords match! <img src="/Roland-Musical page/img/checked.png" width="30px">';
  
  } else {
    passwordRepeatInputResult.innerHTML = 'No match! Please re-enter it! <img src="/Roland-Musical page/img/error.png" width="30px"';
  }
}
